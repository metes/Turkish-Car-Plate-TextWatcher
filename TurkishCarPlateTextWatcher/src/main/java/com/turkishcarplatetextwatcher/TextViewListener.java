 ...
 * Created by Jeremy B.
 */
// Referance: https://stackoverflow.com/a/42951863/1536286
public abstract class TextViewListener implements TextWatcher {
    ...
    /**
     * Call this method when you addFragment to update the text view, so it stops listening to it and then prevent an infinite loop.
     *
     * @see #endUpdates()
     */
